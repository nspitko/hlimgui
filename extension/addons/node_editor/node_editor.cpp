...
//
DEFINE_PRIM(_BOOL, nodeeditor_link, _I64 _I64 _I64 _DYN _REF(_F32) );
//
...
DEFINE_PRIM(_BOOL, nodeeditor_query_new_link2, _REF(_I64) _REF(_I64) _DYN _REF(_F32) );
DEFINE_PRIM(_BOOL, nodeeditor_query_new_node, _REF(_I64) );
DEFINE_PRIM(_BOOL, nodeeditor_query_new_node2, _REF(_I64) _DYN _REF(_F32) );
...
//
DEFINE_PRIM(_VOID, nodeeditor_set_node_position, _I64 _DYN );
DEFINE_PRIM(_DYN, nodeeditor_get_node_position, _I64 );
DEFINE_PRIM(_VOID, nodeeditor_set_group_size, _I64 _DYN );
DEFINE_PRIM(_DYN, nodeeditor_get_node_size, _I64 );
